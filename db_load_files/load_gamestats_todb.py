...
import os
import sys
from sqlalchemy import create_engine, Table, Column, Integer,BigInteger, String, MetaData, Float, DateTime
...
csv_files_and_mappings = [
    ...
    (r"C:\Users\eric\Documents\cost_of_cup\Kaggle_Big_stats\game_plays.csv", game_plays,{'play_id': 'play_id', 'game_id': 'game_id', 'team_id_for': 'team_id_for', 'team_id_against': 'team_id_against', 'event':'event', 'secondaryType': 'secondaryType', 'x':'x', 'y':'y', 'period':'period', 'periodType': 'periodType', 'periodTime': 'periodTime',  'periodTimeRemaining': 'periodTimeRemaining', 'dateTime': 'dateTime', 'goals_away': 'goals_away','goals_home': 'goals_home' }),
    
    (r"C:\Users\eric\Documents\cost_of_cup\Kaggle_Big_stats\game_shifts.csv", game_shifts, {'game_id': 'game_id', 'player_id':'player_id', 'period':'period','shift_start': 'shift_start', 'shift_end':'shift_end'}),
    
    (r"C:\Users\eric\Documents\cost_of_cup\Kaggle_Big_stats\game_skater_stats.csv", game_skater_stats, {'player_id': 'player_id', 'game_id': 'game_id', 'team_id':'team_id', 'timeOnIce': 'timeOnIce', 'assists': 'assists', 'goals':'goals', 'shots':'shots', 'hits':'hits', 'powerPlayGoals':'powerPlayGoals', 'powerPlayAssists': 'powerPlayAssists', 'penaltyMinutes':'penaltyMinutes', 'faceOffWins':'faceOffWins', 'faceoffTaken': 'faceoffTaken', 'takeaways':'takeaways', 'giveaways':'giveaways', 'shortHandedGoals':'shortHandedGoals', 'shortHandedAssists': 'shortHandedAssists', 'blocked': 'blocked', 'plusMinus':'plusMinus', 'evenTimeOnIce': 'evenTimeOnIce', 'shortHandedTimeOnIce':'shortHandedTimeOnIce', 'powerPlayTimeOnIce':'powerPlayTimeOnIce'})
    ]
